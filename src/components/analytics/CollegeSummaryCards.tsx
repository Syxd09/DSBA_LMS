...
import { FileText, TrendingUp, Award, AlertTriangle, Building2, Lock } from 'lucide-react';

interface CollegeSummaryCardsProps {
  summary: {
  ...
  onCardClick?: (type: 'total' | 'score' | 'marks' | 'at-risk' | 'departments' | 'locks') => void;
}

/**
 * College-wide summary cards for Principal
 * 6 cards: Total Feedback, Avg Score, Avg Marks, At-Risk, Departments, Pending Locks
 */
export function CollegeSummaryCards({ summary, pendingLocksCount = 0, onCardClick }: CollegeSummaryCardsProps) {
